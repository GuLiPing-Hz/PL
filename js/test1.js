...
console.log("自动转科学计数小数点前数字多余21位", 1000000000000000000, 1000000000000000000000);
console.log("自动转科学计数小数点后数字多余5位", 0.000001, 0.0000001);
...
console.log('obj["100"]=', obj["100"], obj[100]);
 ...
 * 属性的查看
 */
console.log("查看一个对象本身的所有属性", Object.keys(obj));
/**
 * 属性的删除
...
var a = 1;
var x = function () {
  console.log("测试函数作用域", a);//这里的a只能是全局作用域的a,f5函数作用域的a是不能在这里声效的
};
function f5() {
  var a = 2;
  x();
