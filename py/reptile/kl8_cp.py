...
def get_from_caipiaokong():
    ...
    #http 查询
    params = urllib.parse.urlencode({'username':'jjhhh','password':'e10adc3949ba59abbe56e057f20f883e'
        ,'questionid':0,'answer':''})
    # "Accept": "text/html"
    # "Accept-Encoding":"utf-8"
    headers = {"Content-type": "application/x-www-form-urlencoded","Accept": "text/plain"
        ,"Accept-Encoding":"gzip",'Cookie':cookie_str,'Connection':'keep-alive','Accept-Language':'zh-CN'
...
def get_from_bjfc():
    ...
    #cj.add_cookie_header()
    headers = {"Content-type": "application/x-www-form-urlencoded","Accept": "text/plain"
    ,"Accept-Encoding":"gzip",'Connection':'keep-alive','Accept-Language':'zh-CN'
    ,'User-Agent':'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36'}
